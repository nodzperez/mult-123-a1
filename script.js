...
buttonGrid.addEventListener("click", (event) => {
  ...
  if (
    target.classList.contains("blue-cap-blue") ||
    target.classList.contains("red-cap-red")
  ) {
    if (target.textContent === "C") {
      // button click event listener for the clear button
      currentNumber = "";
      selectedType = "trivia";
      updateScreen("");
...
async function fetchFact(number, type) {
  try {
    ...
    //endpoints being numbersapi.com/number/math, numbersapi.com/number/date, numbersapi.com/number/year, numbersapi.com/number/trivia, numbersapi.com/random 
